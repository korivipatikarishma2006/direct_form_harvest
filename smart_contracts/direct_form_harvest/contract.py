...
@arc4.abimethod
    def create_task(self, payment_txn: gtxn.PaymentTransaction ,task_id: arc4.UInt64, cilent: arc4.Address, farmer: arc4.Address, reward: arc4.UInt64) -> None:
        ...
        def release_reward(self, task_id: arc4.UInt64, caller: arc4.Address) -> UInt64:
         ...
         result = itxn.Payment(
             ...
             receiver=task_data.farmer.native,
